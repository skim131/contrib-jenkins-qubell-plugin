...
public class ApplicationServiceImplIT extends BaseServiceIT {
    ...
    public void testInvalidCredentialsForLaunch() throws Exception
    {
        ...
        ApplicationServiceWsImpl applicationService = new ApplicationServiceWsImpl(new Configuration(testConfiguration.getUrl(), testConfiguration.getLogin(), "wrong password"));
